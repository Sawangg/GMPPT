    ...
    return (
        <div className="container" key={props.item.index}>
            ...
            {props.item.modif ? <>
                    ...
                    <TextField className="center fieldFormule" multiline label="Nom formule" variant="outlined" size="small" value={props.item.nomFormule} onChange={e => props.onChange(e, undefined)} />
                    ...
                    <Typography className="typoFormule">{props.item.nomFormule}</Typography>
                    <ArrowForwardIcon className="center" />
                    <Typography className="typoFormule">{props.item.formule}</Typography>
